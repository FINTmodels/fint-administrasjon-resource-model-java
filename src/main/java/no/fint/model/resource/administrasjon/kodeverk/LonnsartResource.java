...
public class LonnsartResource extends Lonnsart implements FintLinks {
    public static LonnsartResource create(Lonnsart other) {
        if (other == null) {
            return null;
        }
        if (other instanceof LonnsartResource) {
            return (LonnsartResource)other;
        }
        LonnsartResource result = new LonnsartResource();
